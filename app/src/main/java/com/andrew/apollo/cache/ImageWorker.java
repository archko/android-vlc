...
public abstract class ImageWorker {
    ...
    protected ImageWorker(final Context context) {
        ...
        mDefault = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.icon);
    ...
    private final class BitmapWorkerTask extends AsyncTask<String, Void, TransitionDrawable> {
        ...
        public BitmapWorkerTask(final ImageView imageView, String url) {
     ...
     * @param imageType The type of image URL to fetch for.
     */
    protected void loadImage(final String key, final ImageView imageView, final String url) {
        ...
        if (lruBitmap != null && imageView != null) {
            ...
            final BitmapWorkerTask bitmapWorkerTask = new BitmapWorkerTask(imageView, url);
            final AsyncDrawable asyncDrawable = new AsyncDrawable(mResources, mDefault,
                    bitmapWorkerTask);
            imageView.setImageDrawable(asyncDrawable);
            ApolloUtils.execute(false, bitmapWorkerTask, key, url);
        }
    }
     ...
     */
    protected abstract String processImageUrl();
