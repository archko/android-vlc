...
public class VLCDrawerActivity extends SherlockFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawer.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                SidebarEntry entry = (SidebarEntry) mDrawer.getItemAtPosition(position);
    ...
    private static class MainActivityHandler extends WeakHandler<VLCDrawerActivity> {
        public MainActivityHandler(VLCDrawerActivity owner) {
            super(owner);
        }

        @Override
        public void handleMessage(Message msg) {
            VLCDrawerActivity ma = getOwner();
            if(ma == null) return;
    ...
    private void onOpenMRL() {
        ...
        b.setPositiveButton(R.string.open, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int button) {
                ...
                VLCCallbackTask task = new VLCCallbackTask(VLCDrawerActivity.this)
                {
                    @Override
                    public void run() {
